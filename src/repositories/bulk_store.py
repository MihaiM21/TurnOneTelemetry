...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        print("\nUsage:")
        print("  python -m src.repositories.bulk_store store [year]  - Store all JSON files")
        print("  python -m src.repositories.bulk_store list [year]   - List all stored data")
        print("\nOr import and use the functions directly:")
        print("  from src.repositories.bulk_store import bulk_store_plots, store_custom_data")
