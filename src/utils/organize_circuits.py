...
- lib/constants/circuits/{year}/all_circuits.json (all circuits for that year)
- lib/constants/circuits/{year}/{circuit_id}_{circuit_name}.json (individual circuit files)
"""
...
def organize_circuits_data():
    ...
    combined_file = Path("lib/constants/circuits/all_circuits_2024-2026.json")
    ...
    base_dir = Path("lib/constants/circuits")
